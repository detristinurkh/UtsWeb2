...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-0">Pet Shop</h3>
  ...
  <main class="px-3">
    <h1>Sayangi Peliharaanmu </h1>
    <p class="lead">"Jadikan majikanmu gembul dan lucu agar tetap sehat dan terjaga"</p>
                    <p>Maka tunggu apa lagi ayo berbelanja di toko kami, sehat bersih juga terawat :)</p>
    <p class="lead">
